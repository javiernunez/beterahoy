...
export const QUICK_ACCESS = [
  ...
  { href: "/transporte-publico-betera", label: "Transporte" },
  { href: "/como-empadronarse", label: "Empadronarse" },
];

export const REPORT_CATEGORIES = ["ruido", "trafico", "limpieza", "seguridad"] as const;

export const SITE_NAME = "Betera Hoy";
export const SITE_DESCRIPTION =
  "Noticias de Bétera, qué pasa en el pueblo, denuncias vecinales e información útil: servicios, teléfonos y trámites en el Camp de Túria, Valencia.";
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://beterahoy.es";
export const SITE_INSTAGRAM_URL = "https://www.instagram.com/beterahoy";
