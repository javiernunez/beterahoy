...
const es: Dictionary = {
  ...
  "footer.description": "Portal independiente de Bétera, plural y objetivo: sin afiliación política ni partidista. Un altavoz para los vecinos.",
  ...
  "footer.local": "Local",
  "footer.instagramAria": "Betera Hoy en Instagram (se abre en una pestaña nueva)",
...
const val: Dictionary = {
  ...
  "footer.description": "Portal independent de Bétera, plural i objectiu: sense afiliació política ni partidista. Un altaveu per al veïnat.",
  ...
  "footer.local": "Local",
  "footer.instagramAria": "Betera Hoy a Instagram (s'obre en una pestanya nova)",
