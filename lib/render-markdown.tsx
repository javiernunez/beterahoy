...
const ARTICLE_HTML_BLOCK_CLASS =
  "article-html mb-6 whitespace-normal text-inherit [&_iframe]:aspect-video [&_iframe]:my-6 [&_iframe]:w-full [&_iframe]:max-w-full [&_img]:my-6 [&_img]:w-full [&_img]:max-w-full [&_img]:object-cover [&_a]:font-semibold [&_a]:text-betera-leaf [&_a]:underline [&_a]:decoration-betera-leaf/50 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-betera-forest hover:[&_a]:decoration-betera-forest/60 [&_a_strong]:text-inherit [&_a_strong]:font-semibold [&_p]:mb-4 [&_p:last-child]:mb-0 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:my-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:my-1 [&_h2]:mt-8 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-betera-ink [&_h3]:mt-7 [&_h3]:font-serif [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-betera-ink [&_h4]:mt-6 [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:text-betera-ink [&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:border-betera-leaf [&_blockquote]:pl-5 [&_blockquote]:italic [&_blockquote]:text-betera-ink/75 [&_table]:my-6 [&_table]:w-full [&_th]:border [&_th]:border-betera-sand [&_th]:bg-betera-mist [&_th]:p-2 [&_th]:text-left [&_td]:border [&_td]:border-betera-sand [&_td]:p-2 [&_hr]:my-8 [&_hr]:border-betera-sand";
...
const MD_TH_CLASS = "border border-betera-sand bg-betera-mist p-2 text-left font-semibold text-betera-ink";
const MD_TD_CLASS = "border border-betera-sand p-2 align-top";
