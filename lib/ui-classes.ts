...
export const ui = {
  ...
  btnPrimary:
    "inline-flex items-center justify-center rounded-full bg-betera-forest px-5 py-2.5 text-base font-semibold text-white shadow-sm transition hover:bg-betera-forest-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-betera-leaf",
  btnGhost:
    "inline-flex items-center justify-center rounded-full border border-betera-sand bg-white px-4 py-2 text-base font-medium text-betera-ink transition hover:border-betera-leaf/40 hover:bg-betera-mist",
  ...
  sectionTitle: "font-serif text-2xl font-bold text-betera-ink md:text-3xl",
  pageTitle: "font-serif text-3xl font-bold text-betera-ink md:text-4xl lg:text-[2.75rem]",
