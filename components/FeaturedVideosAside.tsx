...
export function FeaturedVideosAside({
  videos,
  locale,
  linkClassName = "text-betera-leaf hover:text-betera-leaf-dark",
        ...
        {videos.length === 0 ? (
          ...
          videos.map((video) => {
            ...
            return (
              <article
                key={video.id}
                className="rounded-2xl border border-slate-200/80 bg-white p-4 text-left shadow-sm transition hover:border-betera-leaf/30"
              >
