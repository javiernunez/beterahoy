...
export function LazyYouTubeEmbed({ embedUrl, title }: Props) {
  ...
  return (
    <button
      ...
      className="relative mt-3 flex w-full items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-slate-900 pt-[56.25%] text-white transition hover:border-betera-leaf/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-betera-leaf"
      aria-label={title}
    >
