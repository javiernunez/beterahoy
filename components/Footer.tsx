...
export async function Footer() {
  ...
  return (
    <footer className="mt-auto border-t-4 border-betera-leaf bg-betera-forest text-betera-cream">
      <div className="container-page grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-1.5 text-sm">
            ...
            <li>
              <Link href="/videos" className="text-betera-cream/90 transition hover:text-white">
                {getNavLabelByHref("/videos", t)}
              </Link>
            </li>
            <li>
              <Link href="/eventos" className="text-betera-cream/90 transition hover:text-white">
                {getNavLabelByHref("/eventos", t)}
              </Link>
            </li>
            <li>
              <Link href="/denuncias" className="text-betera-cream/90 transition hover:text-white">
                {getNavLabelByHref("/denuncias", t)}
              </Link>
            </li>
            <li>
              <Link href="/denuncias/nueva" className="text-betera-cream/90 transition hover:text-white">
                {t("footer.ctaReport")}
              </Link>
            </li>
            <li>
              <Link href="/comercios" className="text-betera-cream/90 transition hover:text-white">
                {t("footer.ctaCommerce")}
              </Link>
            </li>
            <li>
              <Link href="/el-nostre-poble" className="text-betera-cream/90 transition hover:text-white">
                {getNavLabelByHref("/el-nostre-poble", t)}
              </Link>
            </li>
            <li>
              <Link href="/informacion-util" className="text-betera-cream/90 transition hover:text-white">
                {getNavLabelByHref("/informacion-util", t)}
              </Link>
            </li>
            <li>
              <Link href="/quienes-somos" className="text-betera-cream/90 transition hover:text-white">
                {t("footer.about")}
              </Link>
            </li>
            <li>
              <a
                ...
                className="inline-flex items-center gap-2 text-betera-cream/90 transition hover:text-white"
      ...
      <div className="border-t border-white/10">
        <div className="container-page py-4 text-center text-xs text-betera-cream/55">
