        ...
        return (
          <Link
            ...
            className={`group flex items-center gap-1.5 rounded-full border px-4 py-2 text-sm font-semibold transition ${
              active
                ? "border-betera-leaf bg-betera-mist text-betera-leaf-dark shadow-sm"
                : "border-slate-300 bg-slate-50 text-slate-700 hover:border-blue-400 hover:bg-white hover:text-betera-leaf-dark hover:shadow-sm"
            }`}
          >
