    ...
    <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 p-3">
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="rounded border border-betera-leaf/40 bg-white px-3 py-1 text-sm font-medium text-betera-leaf hover:bg-betera-mist disabled:opacity-60"
        >
      ...
      {authRequired ? (
        <p className="mt-2 text-sm text-slate-700">
          <Link href="/cuenta/iniciar-sesion" className="font-semibold text-betera-leaf hover:underline">
            {isVal ? "Inicia sessió" : "Inicia sesión"}
          </Link>
          {" / "}
          <Link href="/cuenta/registro" className="font-semibold text-betera-leaf hover:underline">
