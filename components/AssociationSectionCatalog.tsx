    ...
    return (
      <div className="container-page max-w-6xl space-y-6 py-8 md:py-10">
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
          ...
          <Link href="/asociaciones" className="mt-3 inline-block font-semibold text-betera-leaf-dark hover:underline">
                ...
                <article key={business.id} className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
                  ...
                  <div className="p-4">
                    ...
                    <h4 className="mt-1 text-base font-semibold text-slate-900">
                      <Link href={`/asociaciones/${business.slug}`} className="hover:text-betera-leaf-dark hover:underline">
                        {business.name}
                      </Link>
                    </h4>
