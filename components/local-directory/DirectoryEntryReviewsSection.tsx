      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <form id={formId} onSubmit={onSubmit} className="border-t border-slate-100 pt-6">
          ...
          <label className="mt-5 block">
            ...
            <input
              ...
              className="mt-1 block w-full max-w-md rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 outline-none ring-betera-leaf/30 focus:border-blue-600 focus:ring-2"
          ...
          <label className="mt-4 block">
            ...
            <textarea
              ...
              className="mt-1 block w-full max-w-2xl rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 outline-none ring-betera-leaf/30 focus:border-blue-600 focus:ring-2"
          ...
          {successFlash ? (
            <p className="mt-4 rounded-lg bg-betera-leaf/10 px-3 py-2 text-sm text-betera-forest">
        ...
        {isAuthenticated ? null : (
          <p className="mt-5 text-sm text-slate-600">
            ...
            <Link href={loginHref} className="font-semibold text-betera-leaf-dark underline-offset-2 hover:underline">
