...
export const metadata: Metadata = {
  ...
  description:
    "Todos los colegios de Bétera: CEIP El Garbí, Virgen del Carmen, L'Olivera, Montealegre, Novaschool, Entrenaranjos, Helios e IALE. Información, teléfonos y webs.",
          ...
          <section key={group.type}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {group.schools.map((school) => (
                ...
                >
                  <h3 className="text-lg font-bold text-slate-900 group-hover:text-betera-leaf">
                    {school.name}
                  </h3>
