...
const descriptionEs =
  "Cobertura de las elecciones municipales 2027 en Bétera (Valencia, Camp de Túria): partidos, programas, candidatos, entrevistas y resultados. Jornada electoral: domingo 23 de mayo de 2027.";
const descriptionVal =
  "Cobertura de les eleccions municipals 2027 a Bétera (València, Camp de Túria): partits, programes, candidats, entrevistes i resultats. Jornada electoral: diumenge 23 de maig de 2027.";
