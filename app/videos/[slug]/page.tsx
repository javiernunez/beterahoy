    ...
    <div className="container-page max-w-6xl">
      <div className="grid gap-10 lg:grid-cols-3 lg:gap-8">
        <article className="min-w-0 lg:col-span-2">
          <Link href="/videos" className="inline-block text-sm font-semibold text-betera-leaf hover:underline">
          ...
          <p className="mt-6">
            <a
              ...
              className="text-sm font-semibold text-betera-leaf hover:text-betera-leaf-dark hover:underline"
            >
