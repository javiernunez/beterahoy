  ...
  return (
    <>
      ...
      <p className="mt-1 text-sm text-slate-600">
        <Link href="/cuenta/iniciar-sesion" className="font-medium text-betera-leaf-dark underline">
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded bg-betera-leaf px-4 py-2 text-sm font-semibold text-white hover:bg-betera-leaf-dark disabled:opacity-60"
        >
