  ...
  return (
    <section className="mt-10">
      ...
      <p className="mb-4 text-sm text-slate-500">
        {isVal
          ? "Més recursos sobre este tema per al veïnat de Bétera."
          : "Más recursos sobre este tema para vecinos de Bétera."}
      </p>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {pages.map((page) => (
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-slate-900 group-hover:text-betera-leaf">
                {page.title}
              </h3>
              {page.isHighlighted ? (
