  ...
  return (
    <article className="container-page max-w-3xl space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Link href="/eventos" className="inline-block text-sm font-semibold text-betera-leaf hover:underline">
      ...
      {eventItem.linkUrl ? (
        <p>
          <a href={eventItem.linkUrl} target="_blank" rel="noreferrer noopener" className="font-semibold text-betera-leaf hover:underline">
