...
export const metadata: Metadata = {
  title: "Política",
  description:
    "Noticias de política local en Bétera, partidos con presencia o actividad en el municipio y vídeos de actualidad política.",
  alternates: { canonical: canonicalPath("/politica") },
  openGraph: {
    type: "website",
    title: `Política en Bétera | ${SITE_NAME}`,
    description:
      "Noticias de política local, partidos y vídeos de actualidad en Bétera, Camp de Túria, Valencia.",
    ...
    <div className="container-page max-w-6xl space-y-12 py-8 md:py-10">
      <header className="max-w-3xl border-b border-slate-200 pb-6">
        ...
        <p className="mt-2 font-serif text-base text-slate-600">
          {isVal
            ? "Notícies de política local, formacions amb presència a Bétera i vídeos d'actualitat."
            : "Noticias de política local, partidos con presencia en Bétera y vídeos de actualidad."}
        </p>
      </header>
              ...
              return (
                <article key={video.id} className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm">
                  ...
                  <h3 className="mt-2 font-serif text-lg font-semibold text-slate-900">
                    <Link href={videoPublicPath(video.slug)} className="hover:text-betera-forest hover:underline">
                      {title}
                    </Link>
                  </h3>
                  ...
                  <Link
                    ...
                    className="mt-2 inline-block text-sm font-semibold text-betera-leaf hover:text-betera-leaf-dark hover:underline"
                  >
