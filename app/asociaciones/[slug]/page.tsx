...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  const pageTitle = `${item.name} · Bétera`;

  return {
    title: pageTitle,
    description: metaDesc,
    keywords: [...DEFAULT_SITE_KEYWORDS, item.name, "asociación Bétera", "asociaciones Bétera", "voluntariado Bétera"],
    category: "nonprofit",
  ...
  return (
    <div className="container-page max-w-5xl space-y-8 py-8 md:py-10">
      ...
      <section className="space-y-4">
        <Link href="/asociaciones" className="text-sm font-semibold text-betera-leaf hover:underline">
                  ...
                  {websiteTrim ? (
                    <li>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1 text-sm font-semibold text-betera-leaf-dark underline-offset-2 group-hover:underline">
                          Web oficial
                        </span>
                  ...
                  {item.instagramUrl ? (
                    <li>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1 text-sm font-semibold text-betera-leaf-dark underline-offset-2 group-hover:underline">Instagram</span>
                        <span className="shrink-0 text-slate-400" aria-hidden>
                          →
                        </span>
                      </a>
                  ...
                  {item.facebookUrl ? (
                    <li>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1 text-sm font-semibold text-betera-leaf-dark underline-offset-2 group-hover:underline">Facebook</span>
                        <span className="shrink-0 text-slate-400" aria-hidden>
                          →
                        </span>
                      </a>
                  ...
                  {item.tiktokUrl ? (
                    <li>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1 text-sm font-semibold text-betera-leaf-dark underline-offset-2 group-hover:underline">TikTok</span>
                        <span className="shrink-0 text-slate-400" aria-hidden>
                          →
                        </span>
                      </a>
      ...
      <RelatedLinksSection
        ...
        subtitle={isVal ? "Altres entitats afins a Bétera." : "Otras entidades afines en Bétera."}
