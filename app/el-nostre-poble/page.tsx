...
export const metadata: Metadata = {
  title: "El Nostre Poble | Patrimoni, tradicions i història a Bétera",
  description:
    "Monuments, tradicions, història, alcaldes i curiositats de Bétera (Camp de Túria, València). Una guia per conèixer el poble a peu de carrer.",
  alternates: { canonical: canonicalPath(pagePath) },
  openGraph: {
    type: "website",
    title: `El Nostre Poble | ${SITE_NAME}`,
    description: "Patrimoni, festes, història local i molt més sobre Bétera.",
